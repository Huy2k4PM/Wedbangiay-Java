		...
		try {
			...
			String deliveryAddress = request.getParameter("deliveryAddress");
			 ...
			 HttpSession session = request.getSession();
				...
				email.setFrom("giaphongquan2407@gmail.com"); 
				email.setFromPassword("uprb zthi qvfa emnn"); 
				email.setTo(emailAddress);
				email.setSubject("Dat hang thanh cong tu Shop 3CT");
				StringBuilder sb = new StringBuilder();
			sb.append("Dear ").append(name).append("<br>");
				sb.append("Ban vua dat dang tu Shop 3CT. <br> ");
				...
				sb.append("Cam on ban da dat hang tai Shop 3CT <br>");
